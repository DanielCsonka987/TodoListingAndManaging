    ...
    return(
        <aside className='aboutContent'>
            ...
            <p>The main role of this app is to maintain the activity list of a previously 
                ...
                datas - suggested the usage of dummy details for manual testing. As an evidence 
                it manages list of users, it shows the registered users of the system by a unique 
                username . After the registration and/or login it is recording the activity, its 
                priority, some notation, present the date of creation, last update of that. 
                It can manage some details of the account - password change or delet the account.
                </p>
            <p>It is a typically MERN, REST-full web application, a full-stack 
                ...
                grid or flex laying out. It is tested by manual and automated methods. 
                It uses typical HTTP 1.1 protocol to keep contatct with the monolitic 
