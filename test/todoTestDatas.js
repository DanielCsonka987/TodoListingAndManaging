module.exports.profilesWithTodos = [
  {
    ...
    last_name: 'Doe',
    username: 'JohnD',
    password: '$2b$12$bxWoBdhpRU95E8q5Bkz1YOy57KVxFtL4KQVAA6eQ8BHfE71D0omSW', //test
    age: 31,
  ...
  },
  {
    ...
    last_name: 'Doe',
    username: 'janed',
    password: '$2b$12$49j8jKCSlTqN8h6mzhHgZ.62wExAInasz1TW3L0r2brEbqstkxThe', //retest
    age: 43,
    todos: [ ]
  },
  {
    ...
    last_name: 'Nicholson',
    username: 'jack',
    password: '$2b$12$koaRuHGBDzRS2SbuJjHb1eRO3GDaktQaj4yJmm.5SifMare9dw8/W', //nich
    age: 64,
    occupation: 'actor',
    todos: [
      {
  ...
  },
  {
    ...
    last_name: 'Holmes',
    username: 'holmes',
    password: '$2b$12$GhYpTUI.GeToIdCZWjR9..1Z6/jvt4y4CFPJbP3D6gbg8wwZhKEvO',  //strong
    age: 61,
  ...
  },
  {
    ...
    last_name: 'Tolstoj',
    username: 'levy',
    password: '$2b$12$JzHyZHXDIm1ygyaZkEaSkObDT1vnuAk4hj3WigjgHMNlP0cq2SwCO', //warpeace
    age: 51,
    occupation: 'writer',
    todos: [
      {
...
module.exports.newProfilesWithoutTodos = [
  {
    ...
    last_name: 'McCoy',
    username: 'mcco',
    password: '$2b$12$OzPYUkXUymu0GqlV8rExWey1JdRVqS1eyrLJaTmgkmOpYnj8SJjl.', //machine
    age: 23,
    occupation: 'engeneer',
    todos: [ ]
  },
  {
    ...
    last_name: 'Jobs',
    username: 'apple',
    password: '$2b$12$dkXxR65XhJ4/3ACPnw9POOVHFIiUc2/nnRtQ9bvT6ECe53nyUy5EO',  //donotforget
    age: 56,
